...
// Images are resized to fit within these bounds (preserving aspect ratio)
// and re-encoded as JPEG to keep the payload under the WebRTC data channel limit.
const MAX_WIDTH = 640;
...
/**
 * Resize an image data URL so it fits within MAX_WIDTH x MAX_HEIGHT
 * and re-encode as JPEG. Returns a data URL.
 */
function resizeImage(dataUrl: string): Promise<string> {
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      // Scale down proportionally if larger than limits
